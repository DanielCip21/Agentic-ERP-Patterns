...
_DOCUMENTS: dict[str, dict] = {
    ...
    "DOC-003": {
        "id": "DOC-003",
        "type": "invoice",
        "filename": "inv_gamma_may2026.pdf",
        "status": "pending",
        "fields": None,
    },
}
...
_EXTRACTED_FIELDS: dict[str, dict] = {
    ...
    "DOC-003": {
        "vendor": "Gamma Supplies",
        "invoice_number": "INV-GS-220",
        "date": "2026-05-15",
        "total": 1200.00,
        "line_items": 2,
        "currency": "USD",
...
def _extract_invoice_fields(document_id: str) -> dict[str, Any]:
    ...
    fields = _EXTRACTED_FIELDS.get(
        document_id, {"error": "Extraction model returned no fields"}
    )
    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "fields": {
                    "type": "object",
                    "description": "Extracted fields dict to validate",
                },
            },
    ...
    },
    {
        ...
        "input_schema": {
            ...
            "properties": {
                ...
                "destination": {
                    "type": "string",
                    "description": "Target queue or department (e.g. accounts_payable)",
                },
            },
