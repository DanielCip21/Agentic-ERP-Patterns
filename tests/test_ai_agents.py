...
class TestDocumentIntelligenceAgent:
    def test_direct_text_response(self):
        ...
        client.messages.create.return_value = _make_text_response(
            "Invoice DOC-001 extracted successfully."
        )
    ...
    def test_dispatch_extract_invoice_fields(self):
        ...
        result = agent._dispatch_tool(
            "extract_invoice_fields", {"document_id": "DOC-001"}
        )
    ...
    def test_dispatch_validate_extracted_data(self):
        ...
        result = agent._dispatch_tool(
            "validate_extracted_data", {"document_id": "DOC-001", "fields": fields}
        )
        assert isinstance(result, dict)
    ...
    def test_dispatch_route_document(self):
        ...
        result = agent._dispatch_tool(
            "route_document",
            {"document_id": "DOC-001", "destination": "accounts_payable"},
        )
        assert isinstance(result, dict)
    ...
    def test_dispatch_flag_for_review(self):
        ...
        result = agent._dispatch_tool(
            "flag_for_review",
            {"document_id": "DOC-003", "reason": "Low confidence extraction"},
        )
        assert isinstance(result, dict)
...
class TestSentimentAgent:
    def test_direct_text_response(self):
        client = MagicMock()
        client.messages.create.return_value = _make_text_response(
            "2 negative feedback items found and escalated."
        )
    ...
    def test_dispatch_get_feedback_batch(self):
        ...
        result = agent._dispatch_tool(
            "get_feedback_batch", {"source": "support_tickets"}
        )
        assert isinstance(result, dict)
    ...
    def test_dispatch_get_feedback_batch_with_limit(self):
        agent = SentimentAgent(client=MagicMock())
        result = agent._dispatch_tool(
            "get_feedback_batch", {"source": "nps_survey", "limit": 2}
        )
        assert isinstance(result, dict)
    ...
    def test_dispatch_analyze_sentiment_negative(self):
        agent = SentimentAgent(client=MagicMock())
        result = agent._dispatch_tool(
            "analyze_sentiment", {"text": "Totally unacceptable service."}
        )
    ...
    def test_dispatch_tag_feedback(self):
        ...
        result = agent._dispatch_tool(
            "tag_feedback",
            {"feedback_id": "FB-001", "tags": ["onboarding", "positive"]},
        )
        assert isinstance(result, dict)
    ...
    def test_dispatch_escalate_negative_feedback(self):
        agent = SentimentAgent(client=MagicMock())
        result = agent._dispatch_tool(
            "escalate_negative_feedback", {"feedback_id": "FB-002", "priority": "high"}
        )
        assert isinstance(result, dict)
...
class TestKnowledgeBaseAgent:
    def test_direct_text_response(self):
        client = MagicMock()
        client.messages.create.return_value = _make_text_response(
            "Found 2 articles about password reset."
        )
    ...
    def test_dispatch_search_with_top_k(self):
        agent = KnowledgeBaseAgent(client=MagicMock())
        result = agent._dispatch_tool(
            "search_knowledge_base", {"query": "sso azure", "top_k": 1}
        )
        assert isinstance(result, dict)
    ...
    def test_dispatch_mark_article_outdated(self):
        agent = KnowledgeBaseAgent(client=MagicMock())
        result = agent._dispatch_tool(
            "mark_article_outdated", {"article_id": "ART-003"}
        )
        assert isinstance(result, dict)
...
class TestForecastingAgent:
    def test_direct_text_response(self):
        client = MagicMock()
        client.messages.create.return_value = _make_text_response(
            "Forecast for PROD-001: 1200 units over 90 days."
        )
    ...
    def test_dispatch_get_historical_sales(self):
        ...
        result = agent._dispatch_tool(
            "get_historical_sales", {"product_id": "PROD-001"}
        )
        assert isinstance(result, dict)
    ...
    def test_dispatch_get_historical_sales_with_periods(self):
        agent = ForecastingAgent(client=MagicMock())
        result = agent._dispatch_tool(
            "get_historical_sales", {"product_id": "PROD-001", "periods": 3}
        )
        assert isinstance(result, dict)
    ...
    def test_dispatch_run_demand_forecast(self):
        agent = ForecastingAgent(client=MagicMock())
        result = agent._dispatch_tool(
            "run_demand_forecast", {"product_id": "PROD-001", "horizon_days": 30}
        )
        assert isinstance(result, dict)
    ...
    def test_dispatch_detect_anomalies(self):
        ...
        result = agent._dispatch_tool(
            "detect_anomalies", {"metric": "daily_orders", "data_points": data}
        )
        assert isinstance(result, dict)
    ...
    def test_dispatch_publish_forecast(self):
        ...
        result = agent._dispatch_tool(
            "publish_forecast", {"product_id": "PROD-001", "forecast": forecast}
        )
        assert isinstance(result, dict)
